                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('curp') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-chevron-circle-down"></i></i></span>
                                    </div>
                                    <input class="form-control{{ $errors->has('curp') ? ' is-invalid' : '' }}" placeholder="{{ __('Curp') }}" type="text" name="curp" value="{{ old('curp') }}" required autofocus>
                                </div>
                                @if ($errors->has('curp'))
                                    <span class="invalid-feedback" style="display: block;" role="alert">
